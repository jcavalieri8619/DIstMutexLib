...
${OBJECTDIR}/cli_interface.o: cli_interface.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++14 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/cli_interface.o cli_interface.cpp

${OBJECTDIR}/client_utils.o: client_utils.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++14 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/client_utils.o client_utils.cpp

${OBJECTDIR}/incomingMsg_handler.o: incomingMsg_handler.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++14 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/incomingMsg_handler.o incomingMsg_handler.cpp

${OBJECTDIR}/internal_utils.o: internal_utils.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++14 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/internal_utils.o internal_utils.cpp

${OBJECTDIR}/localComm_monitor.o: localComm_monitor.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++14 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/localComm_monitor.o localComm_monitor.cpp

${OBJECTDIR}/localComm_sender.o: localComm_sender.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++14 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/localComm_sender.o localComm_sender.cpp
...
${OBJECTDIR}/outgoingReply_handler.o: outgoingReply_handler.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++14 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/outgoingReply_handler.o outgoingReply_handler.cpp

${OBJECTDIR}/remoteComm_monitor.o: remoteComm_monitor.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++14 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/remoteComm_monitor.o remoteComm_monitor.cpp

${OBJECTDIR}/remoteComm_sender.o: remoteComm_sender.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++14 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/remoteComm_sender.o remoteComm_sender.cpp

${OBJECTDIR}/requestQueue_manager.o: requestQueue_manager.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++14 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/requestQueue_manager.o requestQueue_manager.cpp

${OBJECTDIR}/requestQueue_notifier.o: requestQueue_notifier.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++14 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/requestQueue_notifier.o requestQueue_notifier.cpp
...
${TESTDIR}/TestFiles/f3: ${TESTDIR}/tests/IncomingMsgTester.o ${TESTDIR}/tests/newtestrunner1.o ${OBJECTFILES:%.o=%_nomain.o}
	...
	${LINK.cc}   -o ${TESTDIR}/TestFiles/f3 $^ ${LDLIBSOPTIONS} `pkg-config --libs cppunit`   `cppunit-config --libs`   

${TESTDIR}/TestFiles/f2: ${TESTDIR}/tests/localMonitorTester.o ${TESTDIR}/tests/newtestrunner.o ${OBJECTFILES:%.o=%_nomain.o}
	${MKDIR} -p ${TESTDIR}/TestFiles
	${LINK.cc}   -o ${TESTDIR}/TestFiles/f2 $^ ${LDLIBSOPTIONS} `pkg-config --libs cppunit`   `cppunit-config --libs`   
...
${TESTDIR}/TestFiles/f1: ${TESTDIR}/tests/remoteCommMonitor_tester.o ${TESTDIR}/tests/remoteMonitorTestClass.o ${OBJECTFILES:%.o=%_nomain.o}
	${MKDIR} -p ${TESTDIR}/TestFiles
	${LINK.cc}  -Wl,--no-as-needed -o ${TESTDIR}/TestFiles/f1 $^ ${LDLIBSOPTIONS} `pkg-config --libs cppunit`   -lcppunit -ldl 
...
${TESTDIR}/TestFiles/f4: ${TESTDIR}/request_queue_tests/RicartRequestQ_Tests.o ${TESTDIR}/request_queue_tests/newtestrunner2.o ${OBJECTFILES:%.o=%_nomain.o}
	${MKDIR} -p ${TESTDIR}/TestFiles
	${LINK.cc}   -o ${TESTDIR}/TestFiles/f4 $^ ${LDLIBSOPTIONS} `pkg-config --libs cppunit`   `cppunit-config --libs`   


${TESTDIR}/tests/IncomingMsgTester.o: tests/IncomingMsgTester.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++14 `cppunit-config --cflags` -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/IncomingMsgTester.o tests/IncomingMsgTester.cpp


${TESTDIR}/tests/newtestrunner1.o: tests/newtestrunner1.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++14 `cppunit-config --cflags` -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/newtestrunner1.o tests/newtestrunner1.cpp


${TESTDIR}/tests/localMonitorTester.o: tests/localMonitorTester.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++14 `cppunit-config --cflags` -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/localMonitorTester.o tests/localMonitorTester.cpp


${TESTDIR}/tests/newtestrunner.o: tests/newtestrunner.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++14 `cppunit-config --cflags` -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/newtestrunner.o tests/newtestrunner.cpp


${TESTDIR}/tests/remoteCommMonitor_tester.o: tests/remoteCommMonitor_tester.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.cc) -g -I/usr/include/cppunit -std=c++14 -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/remoteCommMonitor_tester.o tests/remoteCommMonitor_tester.cpp


${TESTDIR}/tests/remoteMonitorTestClass.o: tests/remoteMonitorTestClass.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.cc) -g -I/usr/include/cppunit -std=c++14 -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/remoteMonitorTestClass.o tests/remoteMonitorTestClass.cpp
...
${TESTDIR}/request_queue_tests/RicartRequestQ_Tests.o: request_queue_tests/RicartRequestQ_Tests.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++14 `cppunit-config --cflags` -MMD -MP -MF "$@.d" -o ${TESTDIR}/request_queue_tests/RicartRequestQ_Tests.o request_queue_tests/RicartRequestQ_Tests.cpp


${TESTDIR}/request_queue_tests/newtestrunner2.o: request_queue_tests/newtestrunner2.cpp 
	${MKDIR} -p ${TESTDIR}/request_queue_tests
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++14 `cppunit-config --cflags` -MMD -MP -MF "$@.d" -o ${TESTDIR}/request_queue_tests/newtestrunner2.o request_queue_tests/newtestrunner2.cpp
...
${OBJECTDIR}/cli_interface_nomain.o: ${OBJECTDIR}/cli_interface.o cli_interface.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -std=c++14 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/cli_interface_nomain.o cli_interface.cpp;\
	else  \
...
${OBJECTDIR}/client_utils_nomain.o: ${OBJECTDIR}/client_utils.o client_utils.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -std=c++14 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/client_utils_nomain.o client_utils.cpp;\
	else  \
...
${OBJECTDIR}/incomingMsg_handler_nomain.o: ${OBJECTDIR}/incomingMsg_handler.o incomingMsg_handler.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -std=c++14 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/incomingMsg_handler_nomain.o incomingMsg_handler.cpp;\
	else  \
...
${OBJECTDIR}/internal_utils_nomain.o: ${OBJECTDIR}/internal_utils.o internal_utils.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -std=c++14 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/internal_utils_nomain.o internal_utils.cpp;\
	else  \
...
${OBJECTDIR}/localComm_monitor_nomain.o: ${OBJECTDIR}/localComm_monitor.o localComm_monitor.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -std=c++14 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/localComm_monitor_nomain.o localComm_monitor.cpp;\
	else  \
...
${OBJECTDIR}/localComm_sender_nomain.o: ${OBJECTDIR}/localComm_sender.o localComm_sender.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -std=c++14 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/localComm_sender_nomain.o localComm_sender.cpp;\
	else  \
...
${OBJECTDIR}/outgoingReply_handler_nomain.o: ${OBJECTDIR}/outgoingReply_handler.o outgoingReply_handler.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -std=c++14 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/outgoingReply_handler_nomain.o outgoingReply_handler.cpp;\
	else  \
...
${OBJECTDIR}/remoteComm_monitor_nomain.o: ${OBJECTDIR}/remoteComm_monitor.o remoteComm_monitor.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -std=c++14 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/remoteComm_monitor_nomain.o remoteComm_monitor.cpp;\
	else  \
...
${OBJECTDIR}/remoteComm_sender_nomain.o: ${OBJECTDIR}/remoteComm_sender.o remoteComm_sender.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -std=c++14 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/remoteComm_sender_nomain.o remoteComm_sender.cpp;\
	else  \
...
${OBJECTDIR}/requestQueue_manager_nomain.o: ${OBJECTDIR}/requestQueue_manager.o requestQueue_manager.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -std=c++14 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/requestQueue_manager_nomain.o requestQueue_manager.cpp;\
	else  \
...
${OBJECTDIR}/requestQueue_notifier_nomain.o: ${OBJECTDIR}/requestQueue_notifier.o requestQueue_notifier.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -std=c++14 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/requestQueue_notifier_nomain.o requestQueue_notifier.cpp;\
	else  \
